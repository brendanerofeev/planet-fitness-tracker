"""
LEGACY DATABASE MODULE - SQLite Only

This is the original sqlite3-based database implementation, kept for reference.
The application now uses database.py (SQLAlchemy-based) which supports both
SQLite and PostgreSQL.

This file is no longer used by the application but is preserved for:
- Reference and comparison
- Rollback capability if needed
- Understanding the migration from raw SQL to ORM

For new development, use database.py (SQLAlchemy implementation)
"""
